    ...
    <div class="popup__sales_modal" :class="{ 'active': salesStore.modalSales === 'sales__modal' }">
      <div class="sales_modal">
        <div class="header__modal">
          ...
          <a href="#" class="btn-cerrar-popup__sales_modal" @click="closeModal">
...
.popup__sales_modal.active {
  transform: scale(1);
  opacity: 1;
}

.overlay__sales_modal .header__modal {
  position: relative;
  width: 100%;
  display: flex;
  justify-content: center;
...
.overlay__sales_modal .title__modals {
  font-size: 1.5rem;
  font-weight: 600;
...
.btn-cerrar-popup__sales_modal:hover {
